...
#        [100.00000, 0.00000],
    ...
    def __init__(self, obj):
        ...
        obj.addProperty('App::PropertyVector','side1_position','e186','side #1 position').side1_position = FreeCAD.Vector(-750.0, 750.0, 0.0)
        obj.addProperty('App::PropertyFloat','side1_ratio','e186', 'side #1 thickness ratio from nominal').side1_ratio = 5.0
        obj.addProperty('App::PropertyBool','up_only','e186', 'upper part only').up_only = False
        ...
        obj.addProperty('App::PropertyInteger','smoothness','e186', 'number of points for the profile').smoothness = 50
    ...
    def execute(self, fp):
        ...
        wire0 = face0.Wires[0]
        wire1 = face1.Wires[0]
        surf = Part.makeRuledSurface(wire1, wire0)
